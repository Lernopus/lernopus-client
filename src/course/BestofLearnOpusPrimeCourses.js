...
class BestofLearnOpusPrimeCourses extends Component {
    constructor(props) {
        super(props);
        this.state = {
            courses: [],
    ...
    render() {
        ...
        return (
            ...
            tabName = 'Best of Learn Opus Prime' handleLoadMore = {this.handleLoadMore} 
            isLoading = {this.state.isLoading} page = {this.state.page} noDataFoundMsg = 'No Best Courses Found Yet.'
            seeAllLink = {`/courseDetailList/${this.props.currentUser.laUserId}/bestresults`} tabIcon = {<ReadOutlined />} tabKey = {'1'}  isCourse = {true} isUser = {false} isCategory = {false}/>
        );
    }
}

export default withRouter(BestofLearnOpusPrimeCourses);